...
public class Constant {
    ...
    * */
    ...
    // 图像资源路径resources/img/background.png
    ...
    public static final String[] PIPE_IMG_PATH={"resources/img/pipe.png", "resources/img/pipe_top.png", "resources/img/pipe_bottom.png" };
